...
export const PROBE_ROSTER: readonly ProbeRow[] = [
  ...
  { probe: 'probe_deadface.ts', status: 'green', tier: 'fast', why: 'THE DEAD BASE FACE held closed — PLAIN_FACES membership law (surface-pooled, first face, layout BY REFERENCE), the regrow guard (no surface tileset hides base-only kinds under a variants list), live plain-face rolls with revived kinds, seed-stable face pick' },
