...
export const PROBE_ROSTER: readonly ProbeRow[] = [
  ...
  { probe: 'probe_strata.ts', status: 'excluded', excuse: 'red', why: 'RED at HEAD (1 fail, deterministic, off by ONE): "d1 under grove: cavern dominates" wants >200 and the band tallies 199 — the strata weights drifted a hair under the pin' },
  ...
  { probe: 'probe_supportfabric.ts', status: 'excluded', excuse: 'flaky', why: 'FLAKY (3 fails in 22 observed runs): "H4 the affliction festers HARDER than the plain twin (the forgone bite returns at yield)" reads a DIFFERENT burn dps every run (8.4→8.0, 6.3→6.8, 6.5→7.0) — the H4 rig\'s dps sample is not seeded; the rest of the fabric\'s laws pass' },
