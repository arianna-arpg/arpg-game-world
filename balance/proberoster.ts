...
export const PROBE_ROSTER: readonly ProbeRow[] = [
  ...
  { probe: 'probe_seamless.ts', status: 'green', tier: 'fast', why: 'THE RESIDENT PAIR (seamless M0) — the mode law\'s inertness flag-off, the deterministic pair pick + boot mints (drawn == arrived), the tissue-gated open rim with its party leash, THE REBASE AT THE THRESHOLD (world-px continuity, carried floaters, memory replay both ways), and the save refusal' },
