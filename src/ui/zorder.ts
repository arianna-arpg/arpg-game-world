...
//   menubar    — THE MENU BAR (ui/menubar.ts): the HUD's Menu button + its
//                tray. Above every panel and the strip (the button must stay
//                pressable under a dragged panel), under the popups and the
//                tooltip it serves.
