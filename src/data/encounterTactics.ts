...
export const ENCOUNTER_TACTICS:Record<string,EncounterTactic>={
  protect_support:{id:'protect_support',name:'Protect the support',signal:'Protect the back line!',color:'#94d6b0',minLevel:8,
  ...
  crossfire:{id:'crossfire',name:'Crossfire',signal:'Split the firing line!',color:'#e3c48a',minLevel:8,
  ...
  pincer:{id:'pincer',name:'Pincer',signal:'Take the flanks!',color:'#e7a373',minLevel:10,
  ...
  covered_withdrawal:{id:'covered_withdrawal',name:'Covered withdrawal',signal:'Fall back—cover them!',color:'#aec9e3',minLevel:10,
  ...
  root_barrage:{id:'root_barrage',name:'Root barrage',signal:'The roots draw taut…',color:'#acd16c',minLevel:9,
  ...
  countercast:{id:'countercast',name:'Countercast',signal:'Their hands are occupied!',color:'#c4a4e6',minLevel:14,
