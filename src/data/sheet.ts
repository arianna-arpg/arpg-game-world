...
const STAT_BLURBS: Record<string, string> = {
  ...
  blockChance: 'The odds an incoming hit meets your block: damage up to your guard stops cold, the excess seeps through.',
  ...
  enduranceRegenPct: 'How fast spent endurance trickles back: fortify effects are the main refill.',
  ...
  repeatCount: 'Your skills execute extra times after the original one.',
