...
export const HIVECALL_TREE = tree([
  ...
  n('royal_guard', 'Swarm Sovereign', 'Base Swarmling deaths grant 20 Sovereignty, up to 100. Enrage spends it to become a Swarm Sovereign for up to 18 seconds with a separate health pool, Venom Mandibles and Poison Spit. Form death empties the bar and returns you to your body. Press Enrage again to return. 4-second transformation cooldown.'),
  ...
  [n('royal_ferocity', 'Royal Ferocity', 'The Sovereign gains 30% more damage, 25% more action speed and the Royal Cataclysm ultimate: a vast lingering poison storm.'),
    ...
    n('regal_execution', 'Perpetual Reign', 'Transformation immediately hatches up to two missing base Swarmlings. Their deaths can now generate Sovereignty while transformed, extending the form by 3.6 seconds per death (up to 18 seconds remaining).')],
