...
export const RARITY_DEFS: Record<MonsterRarity, RarityDef> = {
  ...
  // Move ten points from magic to normal: whole-cohort magic needs breathing
  // room. Keep the total at 131 so rare/champion chances stay unchanged.
  normal:   { label: '',         weight: 110, affixes: 0, lifeMul: 1,    dmgMul: 1,    sizeMul: 1,    xpMul: 1,  drops: 0, ring: '' },
  magic:    { label: 'Magic',    weight: 12,  affixes: 1, lifeMul: 1.7,  dmgMul: 1.2,  sizeMul: 1.08, xpMul: 2,  drops: 0, ring: '#6c9cff' },
