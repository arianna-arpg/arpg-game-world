...
(function () {
  ...
  var MARK = '<svg class="hwnav-mark" viewBox="0 0 32 32" fill="none" aria-hidden="true"><circle cx="16" cy="16" r="13" stroke="url(#hwNavGrad)" stroke-width="1.5"/><circle cx="16" cy="16" r="4.4" fill="url(#hwNavGrad)"/><circle cx="16" cy="3" r="1.6" fill="#4fd6c4"/><circle cx="27.3" cy="22" r="1.6" fill="#a98bff"/><circle cx="4.7" cy="22" r="1.6" fill="#ff8a4c"/><path d="M16 16 L16 3 M16 16 L27.3 22 M16 16 L4.7 22" stroke="url(#hwNavGrad)" stroke-width="1.1" opacity=".55"/><defs><linearGradient id="hwNavGrad" x1="0" y1="0" x2="32" y2="32"><stop stop-color="#7ff0e1"/><stop offset="1" stop-color="#a98bff"/></linearGradient></defs></svg>';
